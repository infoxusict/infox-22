              ...
              <ul className="list-unstyled social">
                <li className="socialList mb-2">
                  <Link
                    ...
                    to="https://www.instagram.com/infoxpression.usict/"
                    target="_blank"
                  >
                    <svg
                ...
                <li className="socialList">
                  <Link
                    rel="noreferrer"
                    className="listSocialA "
                    to="https://twitter.com/infoxpression_"
                    target="_blank"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <li className="socialList">
                  <Link
                    rel="noreferrer"
                    className="listSocialA"
                    to="https://www.facebook.com/infoxpression/"
                    target="_blank"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <li className="socialList mb-1">
                  <Link
                    rel="noreferrer"
                    className="listSocialA"
                    to="https://www.linkedin.com/company/infoxpression-usict/about/"
                    target="_blank"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
