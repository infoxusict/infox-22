...
import "./Assets/Images/CSS/Footer2.css";
        ...
        <div class="site-section">
          <div class="container">
            <div class="grid md:grid-cols-5">
              <div class=" logo da-color-green">
                <a href="#" class="footer-logo theme text-xl atmosphere ">
                  Info
                </a>
                <a href="#" class="footer-logo theme text-xl atmosphere">
                  Xpression
                </a>
                <p class="copyright text-base">
                  <p>&copy; 2022</p>
                </p>
                <img
              ...
              <div class="">
                <h3 class="customer atmosphere text-lg da-color-green mb-5 mt-12 md:mt-0">
                  Schedule
                </h3>
                <ul class="list-unstyled links ">
                  <li class="customerList mb-2 text-lg">
                    <a class="customerListA" href="#">
                      Dates
                    </a>
                  </li>
                  <li class="customerList text-lg">
                    <a class="customerListA" href="#">
                      Venue
                    </a>
                  </li>
              ...
              <div class="">
                <h3 class="company text-lg atmosphere da-color-green mb-5 mt-12 md:mt-0">
                  Teams
                </h3>
                <ul class="list-unstyled links text-lg">
                  <li class="companyFoot mb-2">
                    <a class="footAcompany" href="#">
                      About us
                    </a>
                  </li>
              ...
              <div class="">
                <h3 class="furtherInfo atmosphere text-lg mb-5 da-color-green mt-12 md:mt-0">
                  Further Information
                </h3>
                <ul class="list-unstyled links">
                  <li class="furtherInformation mb-2 text-lg">
                    <a class="furtherInformationA" href="#">
                      Terms &amp; Conditions
                    </a>
                  </li>
                  <li class="furtherInformation mb-2">
                    <a class="furtherInformationA" href="#">
                      Privacy Policy
                    </a>
                  </li>
              ...
              <div class="">
                <h3 class="followUs atmosphere mb-5 text-lg da-color-green mt-12 md:mt-0">
                  Follow us
                </h3>
                <ul class="list-unstyled social">
                  <li class="socialList mb-2">
                    <a class="listSocialA" href="#">
                      <svg
